...
public class TestAllCases {
    ...
    public void testWordCount(){
        ...
        processor.setParagraph(word);
        Assert.assertEquals("Word Count", 7,processor.getWordCount());
    }
    ...
    public void testVerbCount(){
        ...
        processor.setParagraph(word);
        Assert.assertEquals("Verb Count",1,processor.getVerbCount());
    }
    ...
    public void testAuxVerbCount(){
        ...
        processor.setParagraph(word);
        Assert.assertEquals("Verb Count",1,processor.getAuxVerbCount());
    }
    @Test
    public void testTheCount(){

        processor.setParagraph(word);
        Assert.assertEquals("Verb Count",1,processor.getTheCount());
    }
    @Parameterized.Parameters(name = "String Test {index}: ")
